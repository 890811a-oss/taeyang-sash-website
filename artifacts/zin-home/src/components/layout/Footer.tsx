...
export function Footer() {
  return (
    <footer className="bg-gray-50 border-t border-gray-100 pt-16 md:pt-20 pb-16 md:pb-12 text-gray-500">
      <div className="mx-auto max-w-[1440px] px-5 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16 mb-12 md:mb-16 border-b border-gray-200 pb-12 md:pb-16">
          <div className="md:col-span-1 lg:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <Sun className="h-6 w-6 text-gray-900" />
              <span className="text-xl font-medium tracking-tight text-gray-900">태양산업</span>
            </div>
            <p className="text-[13px] md:text-[14px] leading-relaxed text-gray-500 font-light break-keep">
              빛과 바람을 다스리는 기술,<br />
          ...
          <div className="hidden md:block">
            <h4 className="font-medium text-gray-900 mb-5 text-[14px] tracking-wider uppercase">회사소개</h4>
